...
class App extends React.Component {
  ...
  render() {
    return (
      <div id="body-div">
        <p className="instructions">Put an arbitrary text of format of a GitHub flavored markdown (e.g. a readme text) into the editor below to see the beautyful formatted text below. </p>
        <div id="editor-div">
          <div id="editor-title" className="div-title">Editor</div>
          <textarea id="editor" onChange={this.handleText} rows="20" cols="50" title="Editor">{this.state.text}</textarea>
        </div>
        <div id="preview-div">
